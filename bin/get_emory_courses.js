...
request('http://atlas.college.emory.edu/schedules/index.php?t=5179', { jar: true });

const client = new pg.Client(config);
client.connect();

const base = 'http://atlas.college.emory.edu/schedules/index.php?select=';
const codes = [
  'CS',
  'ECON',
  'CHEM',
  ...
  for (var i = 0; i < codes.length; i++) {
    ...
    request(url, (err, response, body) => {
      ...
      while ((temp = regex.exec(body)) !== null) {
        ...
        const inq = `insert into courses (code, code_label, schoolid, subjectid) values ($1, $2, 56, $3)`;
