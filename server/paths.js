...
router.get('/getExamById/:examid', (req, res, next) => {
...
router.get('/getExam/:schoolCode/:courseCode/:examTypeCode/:termCode', function(req, res, next) {
...
router.post('/processTranscription', (req, res, next) => {
...
router.get('/approveTranscription/:examid', (req, res, next) => {
...
router.get('/getBookmarkedCourses/:userid', (req, res, next) => {
...
router.get('/getUserSchool/:userid', (req, res, next) => {
  const userid = req.params.userid;
...
router.post('/selectSchool', (req, res, next) => {
...
router.post('/bookmarkCourse', (req, res, next) => {
...
router.post('/applyMarketing', (req, res, next) => {
  if (!req.files || req.files.length === 0)
...
router.post('/contentFeedback', (req, res) => {
...
router.post('/dashboardLogin', (req, res) => {
...
router.post('/addToDiscussion', (req, res, next) => {
...
router.post('/reportError', (req, res, next) => {
...
router.get('/getMarketingApps', (req, res, next) => {
...
router.post('/getProblem/:content_id', (req, res, next) => {
...
router.get('/getComments/:contentid', (req, res, next) => {
...
router.get('/deleteComment/:commentid', (req, res, next) => {
...
router.get('/undeleteComment/:commentid', (req, res, next) => {
  const { commentid } = req.params;
...
router.get('/getUpvotes/:contentid', (req, res, next) => {
  const { contentid } = req.params;
...
router.post('/deleteQuestionComment', (req, res, next) => {
  const { id } = req.body;
...
router.get('/getMathLabel/:code', (req, res, next) => {
