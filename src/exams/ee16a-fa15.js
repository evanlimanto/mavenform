    ...
    return (
      <span>
        ...
        <div className="content">
          ...
          <hr className="s5" />
          <VariablesQuestion id={"q3"} content={fa15q3} variables={['x_1', 'x_2']} image={['q3.png']} examCode={examCode} />
          <hr className="s5" />
          <MatrixQuestion id={"q4"} content={fa15q4} rows={2} cols={2} image={['q4-1.png', 'q4-2.png']} examCode={examCode} />
          <hr className="s5" />
          ...
          <hr className="s5" />
          <MatrixQuestion id={"q7a"} content={fa15q7a} rows={4} cols={4} image={['q7a.png']} examCode={examCode} />
          <hr className="s5" />
          <ToggleQuestion id={"q7b"} content={fa15q7b} on="Yes" off="No" image={['q7b.png']} examCode={examCode} />
          <hr className="s5" />
          <ToggleQuestion id={"q7c"} content={fa15q7c} on="Yes" off="No" image={['q7c.png']} examCode={examCode} />
          <hr className="s5" />
          <MatrixQuestion id={"q8a"} content={fa15q8a} rows={6} cols={6} image={['q8a.png']} examCode={examCode} />
          <hr className="s5" />
          <MatrixQuestion id={"q8b"} content={fa15q8b} rows={6} cols={1} image={['q8b-1.png', 'q8b-2.png']} examCode={examCode} />
          <hr className="s5" />
          ...
          <hr className="s5" />
          <ToggleQuestion id={"q8e"} content={fa15q8e} on="Yes" off="No" image={['q8e-1.png', 'q8e-2.png']} examCode={examCode} />
          <hr className="s5" />
          <ToggleQuestion id={"q9a"} content={fa15q9a} on="Yes" off="No" image={['q9a.png']} examCode={examCode} />
          <hr className="s5" />
          <FreeFormQuestion id={"q9b"} content={fa15q9b} hasResponse={false} image={['q9b.png']} examCode={examCode} />
          <hr className="s5" />
          <MatrixQuestion id={"q9c"} content={fa15q9c} rows={3} cols={1} image={['q9c.png']} examCode={examCode} />
          <hr className="s5" />
          ...
          <hr className="s5" />
          <MatrixQuestion id={"q9f"} content={fa15q9f} rows={3} cols={1} image={['q9f-1.png', 'q9f-2.png']} examCode={examCode} />
        </div>
      </span>
    );
  }
