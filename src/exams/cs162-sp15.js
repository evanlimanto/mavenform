  ...
  render() {
    ...
    return (
      <span>
        ...
        <Sidebar examCode='cs162/mt1-sp15' problemIDs={problemIDs} problemTitles={problemTitles} />
        <div className="content">
          ...
          <Element name="q3">
            ...
            <hr className="s5" />
            <Question id={"q3-6"} content={q3_6} solution={q3_6_soln} examCode={examCode}/>
            <hr className="s5" />
            <Question id={"q3-7"} content={q3_7} solution={q3_7_soln} examCode={examCode}/>
            <hr className="s5" />
            <Question id={"q3-8"} content={q3_8} solution={q3_8_soln} examCode={examCode}/>
          </Element>
          <Element name="q4">
            <hr className="s5" />
